...
DeJong::DeJong(double a, double b, long long int dimensions, long long int precision, long long int popSize){
	this->a = a; 
	this->b = b;
...
double DeJong::calculateFunction(const vector<double> &parameters){
	double result = 0;
